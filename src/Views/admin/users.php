...
<table class="table table-striped"><tr><th>Username</th><th>Nominativo</th><th>Ruolo</th><th>Stato</th><th></th></tr><?php foreach($users as $u): ?><tr><td><?= htmlspecialchars($u['username']) ?></td><td><?= htmlspecialchars($u['last_name'].' '.$u['first_name']) ?></td><td><?= htmlspecialchars($u['role']) ?></td><td><?= htmlspecialchars($u['status']) ?></td><td><a class="btn btn-sm btn-danger" href="?action=users&delete=<?= $u['id'] ?>">Elimina</a></td></tr><?php endforeach; ?></table>
